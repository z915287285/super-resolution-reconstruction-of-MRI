...
[Xh, Xl] = rnd_smp_patch_new(TR_IMG_PATH, '*.bmp', patch_size, nSmp, upscale);
...
dict_path = ['Dictionary/D_' num2str(dict_size) '_' num2str(lambda) '_' num2str(patch_size) '_0724_12.mat' ];
